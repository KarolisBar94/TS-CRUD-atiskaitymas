...
class App {
  ...
  public constructor(selector: string) {
    ...
    if (foundElement === null) throw new Error(`element not found '${selector}'`);
  ...
  private renderView = () => {
    ...
    if (selectedBrandId === null) {
      ...
      if (brand === undefined) throw new Error('Select bad Brand');
  ...
  public initialize = (): void => {
    ...
    uxContainer.className = 'bg-secondary d-flex gap-4 align-items-start';
    uxContainer.append(
